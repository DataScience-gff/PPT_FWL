...
posteriormente filtrarlos por lógica de negocio (sentido económico) y valores de estas
...
De no ser posible, se elige otro modelo que considere PIB_var como variable independiente (ARIMA o VAR).
...
Se obtiene el conteo de los valores de la variable que se
encuentren en cada rango los cuales estan definidos de la
siguiente manera:

[//]: # para los escenarios optimista, pesimista y neutral:
...
Después se divide el conteo para cada rango entre el total de las observaciones y esto representa el
